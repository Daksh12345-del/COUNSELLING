...
function selectStream(streamId, tab) {
  document.querySelectorAll('.stream-pill').forEach(t => t.classList.remove('active'));
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  try { renderServices('pcm'); } catch (e) { console.error('renderServices failed:', e); } // default stream
});
